...
1. If you have not yet installed the tools, go to [Appendix A](appendix_a_install_magic.md).
...
###### Section VII: [Writing the Segment Override File (POF)](vii_write_sof.md)
